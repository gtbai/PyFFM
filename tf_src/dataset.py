...
class Dataset(object):
	...
	def __init__(self, data_path):
		...
		self.data_set, self.feature2field, self.field_num, self.feature_num = Dataset.parse_data(data_path)
	...
	def parse_data(cls, data_path):
		...
		for sample in open(data_path, 'r'):
